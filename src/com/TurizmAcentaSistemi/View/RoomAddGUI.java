...
import com.TurizmAcentaSistemi.Helper.Item;
...
//oda ekleme sayfasında seçilen odaya göre dinamik olarak pansiyon tipini getiren metod
        ...
        // 11 - Acenta çalışanının sisteme kayıtlı otellere oda eklediği bölüm.
        // 11 - The section where the agency employee adds rooms to the hotels registered in the system.

        // 12 - Sisteme yeni eklenen odaların fiyatlarının, sezon, pansiyon tipi ve konaklayanların yetişkin/çocuk olma durumuna göre belirlendiği bölüm.
        // 12 - The section where the prices of the rooms newly added to the system are determined according to the season, type of hostel and whether the guests are adults or children.
        ...
        btn_room_add.addActionListener(e -> {
            if (Helper.isFieldEmpty(fld_room_stock) || Helper.isFieldEmpty(fld_adult_price) || Helper.isFieldEmpty(fld_child_price) ||
                ...
                if (Room.add(room_type, stock, season_id, adult_price, child_price, hotel_type_id, hotel_id)) {
                    ...
                    RoomProp.add(room_properties, addedRoom_id, fld_room_bed.getText(), Integer.parseInt(fld_room_area.getText().toString()));
                    Helper.showMsg("done");
