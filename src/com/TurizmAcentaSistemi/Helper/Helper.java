package com.TurizmAcentaSistemi.Helper;
...
public class Helper {
    ...
    // 19 ve 20 - Kullanıcıya başarılı ve hatalı işlemler için uygun pop up mesajları verilir.
    // 19 and 20 - The user receives appropriate pop up messages for successful and failed operations.
    ...
    public static boolean confirm(String str) {
        ...
        switch (str){
            case "sure":
                msg = "Silme işlemi yapılacak! Bu işlemden emin misiniz?";
                break;
            default:
                msg = str;
        }
